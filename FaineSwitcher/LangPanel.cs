...
namespace FaineSwitcher
{
    ...
    public partial class LangPanel : Form
    {
        ...
        public LangPanel()
        {
            ...
            Height = 24;
            AeroCheck();
            SwitcherUI.DPISCALE(this);
            l = Convert.ToInt32(SwitcherUI.xr * l);
            outsidefix(pct_Flag);
        ...
        void Lbl_LayoutNameMouseUp(object sender, MouseEventArgs e)
        {
            ...
            Program.MyConfs.WriteSave("LangPanel", "Position", "X" + Location.X + " Y" + Location.Y);
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (AeroEnabled && SwitcherUI.LangPanelBorderAero)
                pn = new Pen(CurrentAeroColor());
            else
                pn.Color = Program.switcher.LangPanelBorderColor;
