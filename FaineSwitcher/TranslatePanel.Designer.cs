...
namespace FaineSwitcher
{
	partial class TranslatePanel
	{
		...
		SwitcherUI.TextBoxCA txt_Source;
		...
		private void InitializeComponent()
		{
			...
			this.pan_Translations = new FaineSwitcher.TranslatePanel.ColorPanel();
			this.txt_Source = new FaineSwitcher.SwitcherUI.TextBoxCA();
