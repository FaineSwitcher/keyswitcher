...
namespace FaineSwitcher
{
    public class Hotkey
    {
        ...
        /// <summary>
        /// All FaineSwitcher hotkey names and IDs.
        /// </summary>
        public enum HKID
        {
            ConvertLastWord,
        ...
        public static void CallHotkey(Hotkey hotkey, HKID hkID, ref bool hkOK, Action hkAction)
        {
            ...
            if (hotkey.ID == (int)hkID && hotkey.Enabled)
            {
                if (hkOK || once)
                {
                    ...
                    if (SwitcherUI.BlockHKWithCtrl && ContainsModifier((int)hotkey.Modifiers, (int)WinAPI.MOD_CONTROL)) { }
                    else
                    {
                        if (hotkey.Modifiers > 0 && SwitcherUI.RePress)
                        {
        ...
        /// </summary>
        /// <param name="trhk"> raw hotkey from tray menu FaineSwitcher.mm</param>
        /// <returns></returns>
