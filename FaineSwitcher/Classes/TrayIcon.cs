...
namespace FaineSwitcher
{
    public class TrayIcon
    {
        ...
        public TrayIcon(bool? visible = true)
        {
            ...
            trIcon.Icon = Properties.Resources.FaineSwitcher;
        ...
        /// <summary>Toggle FaineSwitcher, enable/disable event handler..</summary>
        ...
        public void Hide()
        {
            if ((SwitcherUI.TrayFlags || SwitcherUI.TrayText) && Program.switcher != null && Program.switcher.flagsCheck != null)
                Program.switcher.flagsCheck.Stop();
            trIcon.Visible = false;
        }
        /// <summary>Shows tray icon.</summary>
        public void Show()
        {
            if (SwitcherUI.TrayFlags || SwitcherUI.TrayText)
                Program.switcher.flagsCheck.Start();
            trIcon.Visible = true;
        }
