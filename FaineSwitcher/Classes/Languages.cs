...
Specify layout code 0 to disable this feature." },
    ...
    public static Dictionary<Element, string> Ukrainian = new Dictionary<Element, string>() {
        ...
        { Element.Switcher, $"Faine Switcher {Assembly.GetExecutingAssembly().GetCustomAttribute<AssemblyFileVersionAttribute>().Version} – вбудований перемикач розкладок. (AI версія)" },
