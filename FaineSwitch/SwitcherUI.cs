...
namespace FaineSwitch
{
    public partial class SwitcherUI : Form
    {
        ...
        readonly string[] SYNC_NAMES = { "FaineSwitch.ini", "snippets.txt", "history.txt", "TSDict.txt", "FaineSwitch.mm" };
        ...
        public static string switcher_folder_appd = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "FaineSwitch");
    ...
    "\r\n->env_system====>__system()<====\r\n->date_esc====>\\__date(HH:mm:ss)<====";
        ...
        protected override void WndProc(ref Message m)
        {
            ...
            if (m.Msg == Program.re)
            { // Restart FaineSwitch
                Logging.Log("Restarting FaineSwitch from command line...");
                Restart();
            }
        ...
        static void ToggleSymIgn()
        {
            if (SymIgnEnabled)
            {
                ...
                Program.switcher.Icon = Program.switcher.icon.trIcon.Icon = Properties.Resources.FaineSwitch;
            }
            else
            {
        ...
        public void ToggleSwitcher()
        {
            ...
            Logging.Log("Switched FaineSwitch enabled state to: [" + ENABLED + "].");
        }
        ...
        void loadHidden()
        {
            ...
            if (!String.IsNullOrEmpty(OverlayExcluded))
            {
                ...
                overlay_excluder.Tick += (_, __) =>
                {
                    ...
                    //					Debug.WriteLine("Toggle FaineSwitch to " +(!ENABLED));
                    ToggleSwitcher();
                };
        ...
        {
            Logging.Log("FaineSwitch Main window visibility changed to [" + !Visible + "].");
            if (Visible)
            {
                Visible = false;
            }
        ...
        public void Restart()
        {
            ...
            //Batch script to restart FaineSwitch.
            var restartSwitcher =
                @"@ECHO OFF
REM You should never see this file, if you are it means during restarting FaineSwitch something went wrong. 
chcp 65001
...
DEL " + restartSwitcherPath;
            ...
            try
            {
                ...
                if (lastTrayFlagLayout != lcid || force)
                {
                    ...
                    if (b != null)
                        ...
                        flagicon = FaineSwitch.Properties.Resources.FaineSwitch;
        ...
        void InitializeTrayIcon()
        {
            ...
            var mm = Path.Combine(nPath, "FaineSwitch.mm");
            if (File.Exists(mm))
            {
                SwitcherMM = true;
...
<Task version=""1.2"" xmlns=""http://schemas.microsoft.com/windows/2004/02/mit/task"">
  <RegistrationInfo>
    ...
    <Description>Starts FaineSwitch with highest priveleges.</Description>
  </RegistrationInfo>
  <Triggers>
    <LogonTrigger>
    ...
    <Exec>
      <Command>" + "\"" + Assembly.GetExecutingAssembly().Location + "\"" + @"</Command>
            ...
            else
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        lnk.Description = "FaineSwitch - Magic layout switcher";
                        lnk.Save();
                    }
                    finally
                    {
        ...
        bool AutoStartExist(bool admin)
        {
            ...
            var lnk = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Startup), "FaineSwitch.lnk");
            bool actual = false;
            if (File.Exists(lnk))
            {
                Type t = Type.GetTypeFromCLSID(new Guid("72C24DD5-D70A-438B-8A42-98424B88AFB8")); //Windows Script Host Shell Object
        ...
        /// <summary>Exits FaineSwitch.</summary>
        ...
        /// <summary>
        /// Unregisters FaineSwitch hotkeys.
        /// </summary>
        ...
        void wc_DownloadProgressChanged(object sender, DownloadProgressChangedEventArgs e)
        {
            ...
            {
                Logging.Log("Download of FaineSwitch update [" + UpdInfo[3] + "] finished.");
                int SwitcherPID = Process.GetCurrentProcess().Id;
                //Downloaded archive
                ...
                //which shutdown running FaineSwitch,
                //delete old version,
...
chcp 65001
SET SwitcherDIR=" + AppDomain.CurrentDomain.BaseDirectory + @"
SET FaineSwitch=" + AppDomain.CurrentDomain.FriendlyName + @"
TASKKILL /PID " + SwitcherPID + @" /F
TASKKILL /IM %FaineSwitch% /F
set i=1
:loop
DEL /Q /F /A ""%SwitcherDIR%%FaineSwitch%""
set /a i=%i%+1
if %i% == 333 goto continue
if not exist ""%SwitcherDIR%%FaineSwitch%"" goto continue
goto loop
:continue
echo %i%
...
START """" ""%SwitcherDIR%FaineSwitch.exe"" " + (!silent ? "\"_!_updated_!_\"" : "\"_!_silent_updated_!_\"") + @"
DEL /Q /F /A ""%TEMP%\" + arch + @"""
...
DEL /Q /F /A ""%TEMP%\UpdateSwitcher.cmd""";
        ...
        string getASD_RemoteSize(bool InZip = false)
        {
            try
            {
                ...
                if (InZip)
                {
                    var data = getResponce("https://github.com/BladeMight/FaineSwitch/releases/latest-commit");
                ...
                var request = (HttpWebRequest)WebRequest.Create("https://raw.githubusercontent.com/BladeMight/FaineSwitch/master/AS_dict.txt");
        ...
        void btn_UpdateAutoSwitchDictionary_Click(object sender, EventArgs e)
        {
            ...
            if (Dowload_ASD_InZip)
            {
                ...
                using (var wc = new WebClient())
                {
                    ...
                    wc.DownloadFile(new Uri("https://github.com/BladeMight/FaineSwitch/releases/download/latest-commit/AS_dict.zip"), zip);
...
DEL ""ExtractASD.cmd""";
                ...
                resp = getResponce("https://raw.githubusercontent.com/BladeMight/FaineSwitch/master/AS_dict.txt");
        ...
        void GetUpdateInfo()
        {
            ...
            var api = "https://api.github.com/repos/BladeMight/FaineSwitch/releases";
            var url = api + "/latest";
        ...
        /// <summary>
        /// Check for updates at FaineSwitch startup.
        /// </summary>
        ...
        #endregion
        /// <summary>
        /// Converts FaineSwitch version string to float.
        /// </summary>
        /// <param name="ver">FaineSwitch version string.</param>
        ...
        {
          //  __lopen("http://github.com/BladeMight/FaineSwitch", "http", false, e.Button == MouseButtons.Right);
        }
        void Lnk_SiteLinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
           // __lopen("http://blademight.github.io/FaineSwitch/", "http", false, e.Button == MouseButtons.Right);
        }
        void Lnk_WikiLinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
          //  __lopen("http://github.com/BladeMight/FaineSwitch/wiki", "http", false, e.Button == MouseButtons.Right);
        }
        void Lnk_ReleasesLinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
          //  __lopen("http://github.com/BladeMight/FaineSwitch/releases", "http", false, e.Button == MouseButtons.Right);
        }
        ...
        static void menuhandle(string act, string arg)
        {
            ...
            if (act == "url")
            {
                ...
                {
                    MessageBox.Show(e.Message + "\n" + arg, "FaineSwitch.mm => " + Program.Lang[Languages.Element.Error], MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
            }
            else if (act == "multi")
            {
        ...
        static void makemenu(string switchermenu)
        {
            ...
            mms.Text = "FaineSwitch Custom Menu";
            foreach (var me in mmls)
            {
                ...
                if (acts.ToLower() == "dir")
                {
                    ...
                    catch (Exception e)
                    {
                        ...
                        Logging.Log("FaineSwitch.mm > DIR error: " + e.Message + e.StackTrace, 1);
                    }
                    continue;
                }
        ...
        void Btn_DownloadUpdateClick(object sender, EventArgs e)
        {
            if (!updating && UpdInfo != null)
            {
                ...
                using (var wc = new WebClient())
                {
                    ...
                    Logging.Log("Downloading FaineSwitch update: " + UpdInfo[3]);
                    try
                    {
        ...
        string SyncUploadZxZ(string content)
        {
            try
            {
                var fname = "FaineSwitch-Sync." + GetRandomString(8) + ".txt";
