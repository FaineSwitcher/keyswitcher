...
namespace FaineSwitch
{
    ...
    { // Keyboard & Mouse Listeners & Event hook
                                               ...
                                               int idChild, uint dwEventThread, uint dwmsEventTime)
        {
            ...
            Logging.Log("Hwnd " + hwnd + ", layout: " + hwndLayout + ", FaineSwitch layout: " + SwitcherUI.GlobalLayout);
            if (SwitcherUI.OneLayout)
                if (hwndLayout != SwitcherUI.GlobalLayout)
                {
                    ...
                    DoLater(() =>
                    {
                        Logging.Log("[ONEL] > Layout in this window [" + title + "] was different, changing layout to FaineSwitch global layout.");
